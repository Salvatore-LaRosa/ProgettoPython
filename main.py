#TODO Domande
#1) Dobbiamo più volte cercare il percorso per poi visualizzare solo il percorso minimo?
#2) Per il livello di sensibilità (ovvero la profondità dell'albero di ricerca) dobbiamo impostarla manualmente noi
#   oppure proviamo per esempio con sensibilità 1 e poi se non troviamo nulla passiamo alla sensibilità 2 e così via?
#   ho provato ma non so se posso modificare il valore delle variabili globali che ho preimpostato
#3) Va bene se usiamo le variabili random o è meglio proseguire linearmente così da analizzare tutti i casi
#   così facendo però se analizziamo parole con la z ad esempio ci mette tanto tempo, mentre con il random riusciamo
#   ad eguagliare la durata
#4) Abbiamo messo che entrambi le parole devono essere all'interno del dizionario va bene?
#   dovremmo mettere che solo la seconda parola deve essere all'interno o va bene uguale?

import random
import tkinter as tk

#queste variabili globali mi servono per impostare il livello di sensibilità e di profondità dell'albero
var=True;var1=True;var2=True;var3=False;var4=False;var5=False;
...
def avvia(word1,word2):
    ...
    print(cammino)
    #print("lunghezza cammino:",len(cammino))
